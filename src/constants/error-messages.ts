export const SERVER_ERROR_MSG = 'Ошибка на стороне сервера';

export const USER_UNAUTHORIZED_MSG = 'Неверные почта или пароль';
export const USER_NOT_AUTH_MSG = 'Необходима авторизация';
export const USER_DUPLICATE_MSG = 'Пользователь уже существует';
export const USER_NOT_FOUND_MSG = 'Пользователь не найден';
export const USER_INCORRECT_ID_MSG = 'Некорректный _id для поиска пользователя';
...
export const CARD_INCORRECT_ID_LIKE_MSG = 'Некорректный _id карточки (лайк)';
export const CARD_INCORRECT_ID_DISLIKE_MSG =
  'Некорректный _id карточки (удаление лайка)';
export const CARD_DELETE_FORBIDDEN_MSG =
